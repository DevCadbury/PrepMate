...
import { Shield, Clock, MessageSquareOff, Eye, Ban, AlertTriangle } from 'lucide-react';
...
const restrictionTypes = [
  { value: 'posting', label: 'Content posting restriction', description: 'User cannot create posts or articles', icon: MessageSquareOff, color: 'text-amber-600 dark:text-amber-400' },
  { value: 'commenting', label: 'Comment restriction', description: 'User cannot comment on posts', icon: MessageSquareOff, color: 'text-amber-600 dark:text-amber-400' },
