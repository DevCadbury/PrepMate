...
export function getReportsAgainst(userId: string): ReportAgainst[] {
  ...
  return [
    { id: 'ra-1', reporter: 'Mike Johnson', reporterEmail: 'mike@email.com', reason: 'Harassment', contentType: 'post' as const, contentPreview: 'This post contains inappropriate language and targeted harassment towards other community members. The user has been warned before about this behavior.', contentTitle: 'Offensive post about algorithms', timestamp: '2 days ago', severity: 'high' as const, status: 'pending' as const },
    { id: 'ra-2', reporter: 'Sara Lee', reporterEmail: 'sara@email.com', reason: 'Spam', contentType: 'comment' as const, contentPreview: 'Check out this amazing offer at example-spam.com for free coding courses and certifications...', timestamp: '1 week ago', severity: 'medium' as const, status: 'resolved' as const, moderationAction: 'Content removed', moderatedBy: 'Admin User', moderatedAt: '5 days ago' },
    { id: 'ra-3', reporter: 'Alice Brown', reporterEmail: 'alice@email.com', reason: 'Inappropriate language', contentType: 'post' as const, contentPreview: 'This post contains profanity and derogatory language directed at specific community members.', contentTitle: 'Offensive post about algorithms', timestamp: '2 weeks ago', severity: 'low' as const, status: 'resolved' as const, moderationAction: 'Warning sent', moderatedBy: 'John Moderator', moderatedAt: '10 days ago' },
    ...(user.reports > 3 ? [
